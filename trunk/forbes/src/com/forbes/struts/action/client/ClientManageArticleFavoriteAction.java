 ...
 */
public class ClientManageArticleFavoriteAction extends DispatchAction {
...
/*
	...
	public ActionForward add(ActionMapping mapping, ActionForm form,
		...
		try{
			FavoriteType favoriteType = favoriteManager.getFavoriteType(new Short("1"));
			...
			if(favoriteManager.checkFavorite(favoriteType, id)) {
				...
				request.setAttribute("RESULT_MESSAGE", "您收藏的文章已经存在！");
			}
	...
	public ActionForward list(ActionMapping mapping, ActionForm form,
		...
		try{
			...
			request.setAttribute("ARTICLE_FAVORITE_LIST", favs );
