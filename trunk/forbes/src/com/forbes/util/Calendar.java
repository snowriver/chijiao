...
public class Calendar {
	...
	private  final char[] iLunarLeapMonthTable = {
	...
	private  final char[] iSolarLunarOffsetTable = {
	...
	public boolean bIsSolarLeapYear(int iYear){
		return ((iYear % 4 == 0) && (iYear % 100 != 0) || iYear % 400 == 0);
	}

	// The days in the month of solar calendar
	 int iGetSYearMonthDays(int iYear, int iMonth){
	...
	public int iGetSNewYearOffsetDays(int iYear, int iMonth, int iDay){
		int iOffsetDays = 0;
	...
	public int iGetLLeapMonth(int iYear){
	...
	public int iGetLMonthDays(int iYear, int iMonth){
	...
	public int iGetLYearDays(int iYear){
 		int iYearDays = 0;
 		int iLeapMonth = iGetLLeapMonth(iYear);
	...
	public int iGetLNewYearOffsetDays(int iYear, int iMonth, int iDay){
		int iOffsetDays = 0;
		int iLeapMonth = iGetLLeapMonth(iYear);
	...
	public String sCalendarSolarToLundar(int iYear, int iMonth, int iDay){
	...
	public String sCalendarLundarToSolar(int iYear, int iMonth, int iDay){
