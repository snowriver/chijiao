...
import com.forbes.hibernate.basedao.BaseVideoTypeDAO;
...
public class VideoTypeDAO extends BaseVideoTypeDAO {
	private static final Log log = LogFactory.getLog(VideoTypeDAO.class);
	// property constants
