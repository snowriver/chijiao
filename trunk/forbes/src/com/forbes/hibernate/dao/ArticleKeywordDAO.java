...
import com.forbes.hibernate.basedao.BaseArticleKeywordDAO;
 ...
 * 
 * @see com.forbes.hibernate.ArticleKeyword
 * @author MyEclipse Persistence Tools
 */

public class ArticleKeywordDAO extends BaseArticleKeywordDAO {
	private static final Log log = LogFactory.getLog(ArticleKeywordDAO.class);
	// property constants
	...
	public List findArticleKeywordByPage( String keyword, String orderby, int beg, int len ) {
