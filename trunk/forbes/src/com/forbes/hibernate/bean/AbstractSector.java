...
public abstract class AbstractSector implements java.io.Serializable {
	...
	/** default constructor */
	public AbstractSector() {
	}

	/** full constructor */
	public AbstractSector(Integer pid, String name, Integer disorder) {
		this.pid = pid;
		this.name = name;
