...
<form name="form1" action="AdminUpdateArticleType.do?act=add&returnUrl=|AdminUpdateArticleType.do|act=list|pno=${PAGER.curPage}|" method="post" onsubmit="return checkSubmit();">
...
<table width="96%" border="0" cellpadding="1" cellspacing="1" align="center" class="tbtitle" style="	background:#E2F5BC;">
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="30">&nbsp;<a href="AdminUpdateArticleType.do?act=list"><u>栏目管理</u></a>&gt;&gt;增加文章类型</td>
        </tr>
      </table></td>
  </tr>
</table>
	    ...
	    <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" id="adset" style="display:none">
		  ...
		  <tr>
            <td height="50">
            	...
            	<input type="button" name="button" id="button" value="返回" class="inputbut" onclick="javascript:location='AdminUpdateArticleType.do?act=list'" />
			</td>
            </tr>
      </table></td>
