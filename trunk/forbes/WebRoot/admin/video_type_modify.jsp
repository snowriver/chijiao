...
<form name="form1" action="AdminUpdateVideoType.do?act=modify&returnUrl=${RETURN_URL }" method="post" onsubmit="return checkSubmit();">
<input type="hidden" name="id" id="id" value="${VIDEO_TYPE.id }" />
<input type="hidden" name="pid" id="pid" value="${VIDEO_TYPE.pid }" />
...
<table width="96%" border="0" cellpadding="1" cellspacing="1" align="center" class="tbtitle" style="	background:#E2F5BC;">
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="30">&nbsp;<a href="AdminUpdateVideoType.do?act=list"><u>栏目管理</u></a>&gt;&gt;增加视频类型</td>
        </tr>
      </table></td>
  </tr>
</table>
...
<table width="168" height="24" border="0" cellpadding="0" cellspacing="0">
	    ...
	    <table width="98%" border="0"  id="needset" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td align="left" class='bline'><input name="name" type="text" id="name" size="30" value="${VIDEO_TYPE.name }" /></td>
          </tr>
          <tr>
            <td height="26" align="left" class='bline'> 排列顺序： </td>
            <td align="left" class='bline'><input name="disorder" size="6" type="text" value="${VIDEO_TYPE.disorder }" /> （由低 -&gt; 高） </td>
          </tr>
	    ...
	    <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" id="adset" style="display:none">
          ...
          <tr>
            ...
            <td align="left"> <textarea name="keywords" cols="40" rows="3" id="keywords">${VIDEO_TYPE.keywords }</textarea>
            </td>
          </tr>
          <tr>
            <td height="65" align="left">类型描述：</td>
            <td height="65" align="left"> <textarea name="description" cols="40" rows="3" id="description">${VIDEO_TYPE.description }</textarea></td>
          </tr>
        </table>
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
		  <tr>
            <td height="50">
            	...
            	<input type="button" name="button" id="button" value="返回" class="inputbut" onclick="javascript:location='AdminUpdateVideoType.do?act=list'" />
			</td>
            </tr>
      </table></td>
