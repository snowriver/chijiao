...
<tr>
      <td height="20" bgcolor="#EDF9D5"> <table width="98%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="70%" align="right"><input name="kw" type="button" id="kw" value="返回关键字管理页" onClick="location='article_keywords_main.php';" class="inputbut"></td>
          </tr>
        </table></td>
  </tr>
    <tr>
	...
	&nbsp;&nbsp;
	[<a href="article_keywords_fetch.php"><u>自动获取关键字</u></a>]</td>
    </tr>
  <tr bgcolor="#E5F9FF">
