...
<form name="form1" action="AdminManageNews.do?act=add&returnUrl=${param.returnUrl }" enctype="multipart/form-data" method="post" onsubmit="return CS_ArchivesAdd();">
 
<table width="96%" border="0" cellpadding="1" cellspacing="1" align="center" class="tbtitle" style="background:#E2F5BC;">
    <tr> 
 		<td height="30">&nbsp;<a href="AdminManageNews.do?act=list"><u>资讯列表</u></a>&gt;&gt;发布资讯</td>
      	<td width="10%">&nbsp;</td>
      	<td width="1%">&nbsp;</td>
    </tr>
</table>
            		...
            		<td height="24" class="bline">
            			...
            			<table width="800" border="0" cellspacing="0" cellpadding="0">
			                <tr>
			                  	...
			                  	<td width="90">附加参数：</td>
			                  	<td>
			                  		<input type="checkbox" name="iscommend" id="iscommend" value="1" checked />推荐			        
			                    </td>
			                </tr>
			            </table>
			   		</td>
		...
		<table width="98%" border="0" align="center" cellpadding="2" cellspacing="2" id="adset" style="display:none">
         <tr>
            <td height="24" width="90" class="bline">
                ...
                <tr>
                  <td width="90">&nbsp;简略标题：</td>
                  <td><input name="shorttitle" type="text" id="shorttitle" style="width:150px" value=""/>
                  </td>
