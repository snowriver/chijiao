			...
			<form method="post" action="../client/ClientLogin.do?act=index" name="loginform">
				...
				<div class="ppcontent" id="ppcontid">
					<ul class="card">
						...
						<a href="ClientRegister.jsp" target="_blank">注册新用户</a><a href="${UC_HOME_URL }/do.php?ac=lostpasswd" target="_blank">忘记密码</a><a href="#" target="_blank">帮助中心</a></dl>
					</ul>
				</div>
			</form>
		</div>
			...
			<div class="passportc">
				...
				<div class="listContA">
					<table width="100%" height="100%">
					  ...
					  <tr height="35%">
					    ...
					    <td valign="bottom"><a href='#' target='_parent'>在线好友(0)</a></td>
					    <td rowspan="2">&nbsp;</td>
					  </tr>
					  <tr height="35%">
					    <td valign="middle"><a href='#' target='_parent'>个人资料</a></td>
					    <td valign="middle"><a href='#' target='_parent'>空间管理</a></td>
					  </tr>
					  <tr height="35%">
					    <td colspan="6">&nbsp;</td>
					  </tr>
				...
				<div class="bottom">
					<ul>
						...
						<li><a href="http://localhost/uc/bbs/memcp.php" target="_blank">论坛管理</a></li>
						<li>|</li>
						
						<li><a href="http://localhost/uc/home/cp.php" target="_blank">圈子管理</a></li>
						<li>|</li>
