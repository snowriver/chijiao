    	...
    	<TD colSpan=3>
      		<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        		...
        		<TR>
          			...
          			<TD class=sub_nav_tit_main><DIV class=sub_nav_ico>修正</DIV></TD>
		                  			...
		                  			<TABLE style="FONT-SIZE: 12px" cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
		                    			...
		                    			<TR>		                      				
		                      				<TD align=left width="72%" height=150>
		                      					<FORM name=form3 onSubmit="return CheckForm(this);" action="ManageAnswer.do?act=modifyAnswer" method=post>
		                        				<TABLE style="FONT-SIZE: 12px" cellSpacing=0 cellPadding=2 width="100%" border=0>
						                          	<TBODY>
						                          	<TR>
						                            	<TD width=59>提问信息:</TD>
						                            	<TD width=306 height=31>${ANSWER.ask.title}</TD>
						                            </TR>
						                          	...
						                          	<TR align=middle>
						                            	<TD colSpan=2 height=117>
						                            		<TEXTAREA id=content  name=content rows=10 cols=50>${ANSWER.content }</TEXTAREA>
						                            	</TD>
						                           	</TR>
						                          	<TR align=middle>
						                            	<TD colSpan=2>
