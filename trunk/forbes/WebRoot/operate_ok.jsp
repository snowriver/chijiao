...
<script>
	...
	document.write("<br/><div style='width:400px;padding-top:4px;height:24;font-size:10pt;border-left:1px solid #b9df92;border-top:1px solid #b9df92;border-right:1px solid #b9df92;background-color:#def5c2;'>创业同路人 提示信息：</div>");
	...
	document.write("<br/><br/><a href='${RETURN_URL}'>如果你的浏览器没反应，请点击这里...</a><br/><br/></div>");
