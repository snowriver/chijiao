...
<div class="onlineCOM list12" id="hot_mtag">
	...
	<div class="layoutCenter">
		...
		<div class="newsFocus" id="ch_8">
			...
			<p>[<a href="${UC_HOME_URL }/index.php" target="_blank">在这里，您可以用一句话记录创业中的点点滴滴，方便快捷地发布日志、与好友们一起分享创业信息、讨论感兴趣的创业话题</a>]</p>
		</div>
...
<div class="ad950x120 area" id="adA">
	<div>
		...
		<a href="http://www.vancl.com/websource/websource.aspx?url=http://www.vancl.com/&source=xushaomin" target="_blank"><img src="http://union.vancl.com/adpic.aspx?w=660&h=90" border="0" width="950" height="120" /></a>
	</div>
...
<div class="ad950x120 area" id="adB">
	<div>
		<img src="images/pic950x120.jpg" width="950" height="120" alt="" />	</div>
</div>
-->
