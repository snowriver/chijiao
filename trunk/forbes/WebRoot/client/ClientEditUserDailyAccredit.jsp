...
<DIV class="ucbody">
	...
	<DIV class=addBday id=main_container>
		<DIV class=tabDiv>
			<UL>
	  			<LI><A class=current id=switch_birthday_button href="javascript:void(0)">修改今日授权</A> </LI>
	  		</UL>
	  	</DIV>
	  	
	  	<DIV class=blockNoBorder>
	  		<form name="planForm" method="post" action="ClientManageUserDailyAccredit.do?act=edit" onsubmit="Check();return false;">
			<INPUT type=hidden id=id name=id value="${USER_DETAILY_ACCREDIT.id }">
			<TABLE class=tellmeTable>
	  			<TBODY>
	  				<TR>
					    <TD class=tellmeNameTd id=name_title_caption>授权人:</TD>
					    <TD class=tellmeInputTd><INPUT class=importInput id=receiver name=receiver value="${USER_DETAILY_ACCREDIT.receiver }"></TD>
	  				...
	  				<TR>
					    ...
					    <TD class=tellmeInputTd><INPUT class=importInput id=title name=title value="${USER_DETAILY_ACCREDIT.title }"></TD>
	  				...
	  				<TR id=sex_form_row>
					    ...
					    <TD class=tellmeInputTd>
					    	<UL>
					        	<LI><INPUT class="importInput2" id=date name=date value="<fmt:formatDate value='${USER_DETAILY_ACCREDIT.date }' type='date'/>" readonly onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"></LI>				       		
					       	</UL>
					 	</TD>
	      			...
	      			<TR id=sex_form_row>
					    ...
					    <TD class=tellmeInputTd>
					    	<UL>
					        	<LI><INPUT class="importInput2" id=limit_time name=limit_time readonly onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:00'})" value="<fmt:formatDate value='${USER_DETAILY_ACCREDIT.limitTime}' pattern='yyyy-MM-dd HH:mm:ss'/>" /></LI>				       		
					       	</UL>
					 	</TD>
					    <TD class=inputDesSpanTd></TD>
					</TR>
				    ...
				    <TR>
					    ...
					    <TD colspan="2">
					    	<textarea id="content" name="content" rows="11" cols="90">${USER_DETAILY_ACCREDIT.content }</textarea> 
					 	</TD>					 
					</TR>
					<TR>
