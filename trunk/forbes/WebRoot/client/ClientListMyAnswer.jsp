...
<script language="javascript" type="text/javascript">
	<!--
		...
		function pageselectCallback(page_id, jq){
		  ...
		  window.location="ClientManageAsk.do?act=answer&pno=" + (page_id+1);
...
<DIV class=mainbody>
	...
	<DIV class=data_opt_title>
		<UL>
  			...
  			<LI><A class=curmenu href="ClientManageAsk.do?act=answer">我的回答</A> </LI>
		...
		<TABLE class=datalist_opt border=0 cellSpacing=0 cellPadding=0 width="95%">
			<TBODY>
		    	...
		    	<c:if test="${empty ASK_LIST}">
		    		<TR>
		    			<TD colspan="5" align="center">无我回答过的问题</TD>
		    		</TR>
		    	</c:if>
