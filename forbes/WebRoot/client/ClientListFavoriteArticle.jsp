...
<script language="javascript" type="text/javascript">
	<!--
		function pageselectCallback(page_id, jq){
		  ...
		  window.location="ClientManageArticleFavorite.do?act=list&pno=" + (page_id+1);
			...
			<TBODY>
		    	...
		    	<c:if test="${empty ARTICLE_FAVORITE_LIST}">
		    		...
		    		<TR>
			    		...
			    		<TD style="WIDTH:50px">文章收藏</TD>
			    		<TD><P class=datalist_opt_video_title><A target=_blank href="../article/ArticleView.do?id=${fav[0].id }"> ${fav[0].title }</A></P></TD>
			    		
			    		<TD><fmt:formatDate value='${fav[0].pubdate}' pattern='yyyy-MM-dd' /></TD>
			    		<TD align="center">
			    			<A href="javascript:void(0);" onclick="deleteArticleFavorite(${fav[1].id },${PAGER.curPage-1});">删除</A>
			      		</TD>
			      	</TR>
		      		</c:forEach>
