...
strHtml += "<div style='background:url(../images/b_top_m.gif) repeat-x;'><div style=\"float:left;width:50%\">[" + title +"]</div><div style=\"float:right;width:10%\"><a href='#' onClick=\"remove()\"> <font color=white> [关闭]</font> </a></div></div></div>\n"; 
