...
strHtml += "<iframe MARGINWIDTH=0 MARGINHEIGHT=0 HSPACE=0 VSPACE=0 FRAMEBORDER=0 SCROLLING=NO src=\"" + url + "\" width=" + widthx +" height="+height+"></iframe>";
strHtml += "</div>\n"; 
