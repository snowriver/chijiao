  					...
  					<TBODY>
  						<TR>
			    			...
			    			<TD class=sub_nav_tit_main>
			      				<DIV class=sub_nav_ico style="FONT-WEIGHT: bold; FONT-SIZE: 14px; COLOR: #fff">用户信息</DIV>
			      			</TD>
				...
				<!--所有问题列表开始-->
			 		<DIV class=all_ask_main>
			      						...
			      						<TD vAlign=top>
			          								...
			          								<TBODY>
			          									<TR>
			            									<TD style="PADDING-LEFT: 20px">
			              										<P>
			              											昵称：<SPAN>${USER.username }</SPAN>&nbsp;&nbsp;&nbsp;
			              										     等级：<SPAN>${USER.userDetail.userLevel }</SPAN>&nbsp;&nbsp;&nbsp;
			              											等级总积分：<SPAN>${BANLANCE }</SPAN>
			              										</P>
			              									</TD>
			              								</TR>
			              							</TBODY>
			        						...
			        						<DIV class=all_ask_jifen>
										        <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
										       		<TBODY>
										          		<TR class=all_ask_jifen_tit>
										            		<TD class=all_ask_jifen_td2>回答明细</TD>
										            	</TR>
										            </TBODY>
										      	</TABLE>
										        <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
  						...
  						<DIV class=user_info_tit>
  							<A class=on href="UserView.do?act=answer&uid=${USER.uid }">${USER.username }用户回答</A> 
  							<A href="UserView.do?act=ask&uid=${USER.uid }">${USER.username }提问</A> 
  						</DIV>
