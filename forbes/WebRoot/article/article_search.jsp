...
<HEAD>
	...
	<SCRIPT language="javascript" type="text/javascript">
		...
		function pageselectCallback(page_id, jq){
		  ...
		  window.location="ArticleSearch.do?act=search&keyword=${param.keyword}&orderby=${param.orderby}&pno=" + (page_id+1);
		...
		<DIV class=news_content>
			...
			<c:forEach items="${ARTICLE_LIST}" var="article"> 
				<DIV style="Z-INDEX: 955" id=enclosure8 class=news-summary>
					<A class="thumb offsite ct-lifestyle" target="_blank" href="${UC_HOME_URL }/space.php?uid=${article.user.uid}"><IMG alt="" src="${UC_CENTER_URL }/avatar.php?uid=${article.user.uid}&size=small&type=virtual" width=48 height=48></A>
					<DIV class=news-body>
