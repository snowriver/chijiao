...
<form name="form1" method="post" action="AdminUpdateVideoType.do?act=move&id=${ARTICLE_TYPE.id }&returnUrl=${RETURN_URL }">
   
<table width="96%" border="0" cellpadding="1" cellspacing="1" align="center" class="tbtitle" style="background:#E2F5BC;">
	<tr>
   		<td width="100%" height="24" colspan="2" bgcolor="#EDF9D5">
   		&nbsp;<a href="AdminUpdateVideoType.do?act=list"><u>栏目管理</u></a>&gt;&gt;移动列表
		</td>
	</tr>
	<tr>
