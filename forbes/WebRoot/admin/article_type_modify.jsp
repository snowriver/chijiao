...
<form name="form1" action="AdminUpdateArticleType.do?act=modify&returnUrl=${RETURN_URL }" method="post" onsubmit="return checkSubmit();">
<input type="hidden" name="id" id="id" value="${ARTICLE_TYPE.id }" />
<input type="hidden" name="pid" id="pid" value="${ARTICLE_TYPE.pid }" />
...
<table width="168" height="24" border="0" cellpadding="0" cellspacing="0">
	    ...
	    <table width="98%" border="0"  id="needset" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td align="left" class='bline'><input name="disorder" size="6" type="text" value="${ARTICLE_TYPE.disorder }" /> （由低 -&gt; 高） </td>
          </tr>
