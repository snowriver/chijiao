...
<%
	...
	com.forbes.hibernate.bean.Article article = (com.forbes.hibernate.bean.Article) request
			.getAttribute("ARTICLE");
	if (article.getArticleType() != null)
		request.setAttribute("ARTICLE_TYPE_LIST", ss
				.getArticleTypes(article.getArticleType().getId()
						.toString()));
...
-->
	...
	<body topmargin="8">
		...
		<form name="form1"
			action="AdminEditArticle.do?act=edit&returnUrl=${RETURN_URL }"
			enctype="multipart/form-data" method="post"
			onsubmit="return CS_ArchivesAdd();">
			...
			<table width="96%" border="0" cellpadding="1" cellspacing="1"
				...
				<tr>
					<td height="30">
						&nbsp;
						<a href="AdminUpdateArticle.do?act=list"><u>文章列表</u>
						</a>&gt;&gt;修改文章
					</td>
					<td width="10%">
						&nbsp;
						<a href="AdminUpdateArticleType.do?act=list">[<u>栏目管理</u>]</a>
					</td>
					<td width="1%">
						&nbsp;
					</td>
				...
				<tr>
					<td bgcolor="#FFFFFF">
						<table width="100%" border="0" align="center" cellpadding="0"
							cellspacing="0" id="head1" class="htable"
							style="border-bottom: 1px solid #99CC33">
							<tr>
								<td colspan="2" bgcolor="#E2F5BC">
									<table border="0" cellpadding="0" cellspacing="0">
										<tr>
											<td width="84" height="24" align="center" bgcolor="#FFFFFF">
												&nbsp;常规内容&nbsp;
											</td>
											<td width="84" align="center" bgcolor="#006600">
												<a href="#" class="STYLE1" onclick="ShowItem2()"><u>其它参数</u>
												</a>
											</td>
										</tr>
									</table>
						...
						<table width="100%" border="0" align="center" cellpadding="0"
							cellspacing="0" id="head2"
							style="border-bottom: 1px solid #99CC33; display: none">
							<tr>
								<td colspan="2" bgcolor="#E2F5BC">
									<table height="24" border="0" cellpadding="0" cellspacing="0">
										<tr>
											<td width="84" align="center" bgcolor="#006600">
												<a href="#" class="STYLE1" onclick="ShowItem1()"><u>常规内容</u>
												</a>&nbsp;
											</td>
										...
										<tr>
											...
											<td width="350">
												<input name="title" type="text" id="title"
													style="width: 330px" value="${ARTICLE.title }" />
											</td>
											<td width="90">
												附加参数：
											</td>
			                  		...
			                  		<c:if test="${ ARTICLE.iscommend != 0}">
			                  		 ...
			                  		 -->
												...
												<c:if test="${ ARTICLE.isverify == 0}">
													<input type="checkbox" name="isverify" id="isverify"
														value="1" />审核
			                  		</c:if>
												<c:if test="${ ARTICLE.isverify != 0}">
													<input type="checkbox" name="isverify" id="isverify"
												...
												<select name="iscommend">
													<option value="0"
														<c:if test="${ ARTICLE.iscommend == 0}">selected</c:if>>
														不推荐
													</option>
													<option value="1"
														<c:if test="${ ARTICLE.iscommend == 1}">selected</c:if>>
														1
													</option>
													<option value="2"
														<c:if test="${ ARTICLE.iscommend == 2}">selected</c:if>>
														2
													</option>
													<option value="3"
														<c:if test="${ ARTICLE.iscommend == 3}">selected</c:if>>
														3
													</option>
													<option value="4"
														<c:if test="${ ARTICLE.iscommend == 4}">selected</c:if>>
														4
													</option>
													<option value="5"
														<c:if test="${ ARTICLE.iscommend == 5}">selected</c:if>>
														5
													</option>
												</select>
											</td>
								...
								<td height="24" class="bline">
									<table width="800" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td>
												<input name="tag" type="text" id="tag" style="width: 300px"
										...
										<tr>
											...
											<td width="240" height="33">
												<input name="source" type="text" id="source"
													style="width: 160px" size="16" value="${ARTICLE.source }" />
												<input name="selsource" type="button" id="selsource"
													value="选择" class="inputbut" value="${ARTICLE.writer }" />
											</td>
											<td width="90" height="33">
												作 者：
											</td>
											<td height="33">
												<input name="writer" type="text" id="writer"
													style="width: 120px" />
												<input name="selwriter" type="button" id="selwriter"
													value="选择" class="inputbut" />
											</td>
										</tr>
									</table>
								</td>
										...
										<tr>
											...
											<td width="464">
												<table width="100%" border="0" cellspacing="1"
													...
													<tr>
														<td height="30">
															<input name="litpictype" value="1" type="radio"
																onclick="SelectPicType(1);" onselect="SelectPicType(1);"
																checked="checked" />
															无
															<input name="litpictype" value="2" type="radio"
																onclick="SelectPicType(2);" onselect="SelectPicType(2);" />
															本地上传
															<input name="litpictype" value="3" type="radio"
																onclick="SelectPicType(3);" onselect="SelectPicType(3);" />
															在网站内选择
															<input name="litpictype" value="4" type="radio"
																onclick="SelectPicType(4);" onselect="SelectPicType(4);" />
															远程图片
														</td>
													</tr>
													<tr>
														<td height="30">
															...
															<div id="litpictype2" style="display: none">
																<input name="locallitpic" type="file" id="locallitpic"
																	style="width: 200px"
																	onchange="SeePic(document.picview,document.form1.litpic);" />
																本地上传请点击“浏览”按钮
															</div>
															<div id="litpictype3" style="display: none">
																<input name="litpicurl" type="text" id="litpicurl"
																	style="width: 250px" />
																<input type="button" name="Submit2" value="在网站内选择"
																	style="width: 120px"
																	onclick="SelectImage('form1.picname','small');"
																	class="inputbut" />
															</div>
															<div id="litpictype4" style="display: none">
																<input name="litpicurl2" type="text" id="litpicurl2"
																	style="width: 250px" />
																&nbsp;请填写图片的详细地址
															</div>
														</td>
											...
											<td width="201" align="center">
												<c:if test="${empty ARTICLE.litpic }">
													<img src="img/pview.gif" width="150" height="100"
														id="picview" name="picview" />
												</c:if>
												<c:if test="${not empty ARTICLE.litpic }">
													<img src="../${ARTICLE.litpic }" width="150" height="100"
														id="picview" name="picview" />
												</c:if>
											</td>
										</tr>
								...
								<td height="24" class="bline">
									<table width="800" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td width="300">
												<select id="maintypeid" name="maintypeid"
													style="width: 240px"
													onchange="onSelectTopArticleType(this)">
													<option value="0">
														请选择主类型
													</option>
													<c:forEach items="${TOP_ARTICLE_TYPE_LIST}" var="at"
														varStatus="is">
														<c:if test="${ARTICLE.articleType.id == at.id }">
															<option value="${at.id }" selected>
																${at.name }
															</option>
														</c:if>
														<c:if test="${ARTICLE.articleType.id != at.id }">
												...
												<select id="typeid" name="typeid" style="width: 240px"
													...
													<c:if test="${not empty ARTICLE.articleType}">
														...
														<c:if test="${not empty ARTICLE.articleType2}">
															...
															<c:forEach items="${ARTICLE_TYPE_LIST}" var="type">
																<option value="${type.id}"
																	<c:if test="${ARTICLE.articleType2.id == type.id}">selected</c:if>>
																	${type.name}
																</option>
															</c:forEach>
														</c:if>
								...
								<td width="100%" height="24" class="bline">
									<table width="800" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td>
												<input type="radio" name="sptype" value="hand" checked />
												不分页
												<input type="radio" name="sptype" value="auto" />
												自动分页 自动分页大小：
												<input type="text" name="spsize" value="3" id="spsize"
													size="6" />
												(K)
											</td>
										</tr>
						...
						<table width="98%" border="0" align="center" cellpadding="2"
							cellspacing="2" id="adset" style="display: none">
							<tr>
								<td height="24" width="90" class="bline">
									<table width="800" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td>
												<input name="shorttitle" type="text" id="shorttitle"
													style="width: 350px" value="${ARTICLE.shorttitle }" />
											</td>
										...
										<tr>
											...
											<td>
												<input name="pubdate" value="${ARTICLE.pubdate }"
													type="text" id="pubdate" style="width: 200px" />
											</td>
										...
										<tr>
											...
											<td>
												<input name="color" type="text" id="color"
													style="width: 120px" value="${ARTICLE.color }" />
												<input name="modcolor" type="button" id="modcolor"
													value="选取" onclick="ShowColor()" class="inputbut" />
											</td>
										</tr>
									</table>
								</td>
								...
								<td height="24" class="bline">
									<table width="800" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td>
												<input type="radio" name="ishtml" value="1" checked />
												生成HTML
							...
							<tr>
								<td height="76" class="bline">
									<table width="800" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td width="90" height="51">
												&nbsp;文档摘要：
											</td>
											<td width="800">
												&nbsp;&nbsp;
												<textarea name="description" rows="8" id="description"
													style="width: 90%">${ARTICLE.description }</textarea>
											</td>
											<td>
												&nbsp;
											</td>
								...
								<td height="76" class="bline">
									<table width="800" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td width="446">
												<textarea name="keywords" rows="3" id="keywords"
													style="width: 80%">${ARTICLE.keywords }</textarea>
											</td>
											<td>
												用空格分开
												<br />
												<input type="button" name="Submit" value="浏览..."
													style="width: 56px; height: 20"
									...
									<table width="800" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td width="446">
												...
												<textarea name="likeid" rows="3" id="likeid"
													style="width: 80%;">${ARTICLE.likeid }</textarea>
											</td>
											<td>
												把文档ID，用逗号“,”分开
												<br />
												<input name="lsel" type="button" id="lsel" class="nbt"
													style="width: 150px" onchange="" value="从已发布文档中选取..."
													onclick="SelectArcListA();" />
											</td>
										</tr>
									</table>
								</td>
								...
								<td height="56">
									<table width="100%" border="0" cellspacing="1" cellpadding="1">
										<tr>
											...
											<td width="83%">
												<table width="214" border="0" cellspacing="0"
													cellpadding="0">
													<tr>
														<td width="115" height="35">
															<input name="imageField" type="submit" class="inputbut"
																value="确定" />
														</td>
														<td width="99" height="35">
															<input name="button" type="reset" class="inputbut"
																id="button" value="重置" />
														</td>
													</tr>
												</table>
