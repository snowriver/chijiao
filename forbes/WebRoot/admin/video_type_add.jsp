...
<form name="form1" action="AdminUpdateVideoType.do?act=add&returnUrl=|AdminUpdateVideoType.do|act=list|pno=${PAGER.curPage}|" method="post" onsubmit="return checkSubmit();">
...
<table width="168" height="24" border="0" cellpadding="0" cellspacing="0">
	    ...
	    <table width="98%" border="0"  id="needset" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td align="left" class='bline'><input name="name" type="text" id="name" size="30" /></td>
          </tr>
          <tr>
            <td height="26" align="left" class='bline'> 排列顺序： </td>
            <td align="left" class='bline'><input name="disorder" size="6" type="text" value="50" /> （由低 -&gt; 高） </td>
          </tr>
	    ...
	    <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" id="adset" style="display:none">
          ...
          <tr>
            ...
            <td height="65" align="left"> <textarea name="description" cols="40" rows="3" id="description"></textarea></td>
          </tr>
        </table>
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
		  <tr>
