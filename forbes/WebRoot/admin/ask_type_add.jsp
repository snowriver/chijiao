...
<form name="form1" action="AdminManageAskType.do?act=add&returnUrl=|AdminManageAskType.do|act=list|pno=${PAGER.curPage}|" method="post" onsubmit="return checkSubmit();">
