...
<form name="form1" action="AdminEditArticle.do?act=add&returnUrl=${param.returnUrl }" enctype="multipart/form-data" method="post" onsubmit="return CS_ArchivesAdd();">
 
<table width="96%" border="0" cellpadding="1" cellspacing="1" align="center" class="tbtitle" style="background:#E2F5BC;">
    <tr> 
 		<td height="30">&nbsp;<a href="AdminUpdateArticle.do?act=list"><u>文章列表</u></a>&gt;&gt;发布文章</td>
		...
		<td bgcolor="#FFFFFF">
        	...
        	<table width="98%"  border="0" align="center" cellpadding="2" cellspacing="2" id="needset">
          		<tr>
            		<td height="24" class="bline">
            			...
            			<table width="800" border="0" cellspacing="0" cellpadding="0">
			                <tr>
			                  	<td width="90">&nbsp;文章标题：</td>
			                  	<td width="350"><input name="title" type="text" id="title" style="width:330px" value="${TITLE }" /></td>
			                  	<td width="90">附加参数：</td>
			                  	<td>
			                  		<!-- 
		      		...
		      		<td height="24" class="bline">
			   			<table width="800" border="0" cellspacing="0" cellpadding="0">
		          			<tr> 
		            			...
		            			<td><input name="tag" type="text" id="tag" style="width:300px" value="${TAG }" /> (用空格或','分开)</td>
		          			</tr>
		       			</table>
	 				</td>
    			</tr>
                ...
                <tr>
                  ...
                  <td width="201" align="center"><img src="img/pview.gif" width="150" height="100" id="picview" name="picview" /></td>
                </tr>
            </table></td>
          </tr>
          <tr>
		...
		<table width="98%" border="0" align="center" cellpadding="2" cellspacing="2" id="adset" style="display:none">
         <tr>
            <td height="24" width="90" class="bline">
                ...
                <tr>
                  <td width="90">&nbsp;简略标题：</td>
                  <td><input name="shorttitle" type="text" id="shorttitle" style="width:350px" value="${TITLE }"/>
                  </td>
	...
	<tr>
	  ...
	  <table width="800" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="800">&nbsp;&nbsp;<textarea name="description" rows="8" id="description" style="width:90%"></textarea></td>
          <td>&nbsp;</td>
        </tr>
      </table></td>
    </tr>
