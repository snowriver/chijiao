...
/**
 * AbstractCdbForums entity provides the base persistence definition of the
 * CdbForums entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public abstract class AbstractCdbForums implements java.io.Serializable {
	...
	private Byte allowtag;
	private Byte allowglobalstick;

	// Constructors

	/** default constructor */
	public AbstractCdbForums() {
	}

	/** full constructor */
	public AbstractCdbForums(Short fup, String type, String name, Byte status,
	...
	public Byte getAllowtag() {
		return this.allowtag;
	}

	public void setAllowtag(Byte allowtag) {
		this.allowtag = allowtag;
	}
