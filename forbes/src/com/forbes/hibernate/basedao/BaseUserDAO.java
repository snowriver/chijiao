...
public class BaseUserDAO extends HibernateDaoSupport {
	...
	public User findById(java.lang.Integer id) {
		...
		try {
			User instance = (User) getHibernateTemplate().get(
					"com.forbes.hibernate.bean.User", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByEmail(Object email) {
		return findByProperty(TYPE, email);
	}
	...
	public static BaseUserDAO getFromApplicationContext(ApplicationContext ctx) {
		return (BaseUserDAO) ctx.getBean("UserDAO");
	}
}