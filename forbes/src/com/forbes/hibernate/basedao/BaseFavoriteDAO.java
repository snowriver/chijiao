 ...
 * 
 * @see com.forbes.hibernate.bean.Favorite
 * @author MyEclipse Persistence Tools
 */

public class BaseFavoriteDAO extends HibernateDaoSupport {
	private static final Log log = LogFactory.getLog(BaseFavoriteDAO.class);
	// property constants
	...
	public Favorite findById(java.lang.Integer id) {
		...
		try {
			Favorite instance = (Favorite) getSession().get(
					"com.forbes.hibernate.bean.Favorite", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Favorite instance) {
		...
		try {
			List results = getSession().createCriteria(
					"com.forbes.hibernate.bean.Favorite").add(
